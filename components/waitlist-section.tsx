    ...
    <section id="waitlist" className="py-32 px-6 pb-[14vw] sm:pb-[16vw] lg:pb-[18vw] bg-background">
      <div className="max-w-xl mx-auto text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-normal mb-4 text-balance font-serif">
          Be first to know when doors open.
        </h2>
        <p className="text-muted-foreground mb-10 leading-relaxed">
          Spots are limited. Get early access and first details direct to your inbox.
        </p>
        ...
        {formState === "success" ? (
          <div className="bg-card border border-border rounded-3xl p-10">
            ...
            <p className="text-muted-foreground text-sm">
              We&apos;ll be in touch with details as soon as the first event is confirmed.
            </p>
          </div>
        ) : (
